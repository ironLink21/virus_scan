...
def run_scan(myFile, log_file, virus_chest):
    args = ['clamscan', '-irz', myFile, '--exclude-dir=/sys/', '--exclude-dir=/home/seth/Games/','--exclude-dir={0}'.format(virus_chest),'--quiet', '--cross-fs', '-l', log_file,'--move={0}'.format(virus_chest)]
